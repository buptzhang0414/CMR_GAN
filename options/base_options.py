...
class BaseOptions():
    ...
    def initialize(self):
        #self.parser.add_argument('--isTrain', type=str, default='train')
        ...
        self.parser.add_argument('--dir_blur', type=str, default='blur_path')
        self.parser.add_argument('--dir_sharp', type=str, default='sharp_path')
        self.parser.add_argument('--name_list_blur', type=str, default='name_list_blur')
        self.parser.add_argument('--name_list_sharp', type=str, default='name_list_sharp')
